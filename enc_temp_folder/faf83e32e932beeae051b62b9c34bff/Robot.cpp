...
void Robot::rotateHead(float angleVertical, float angleHorizontal) {
    // limiting the head movment to be realistic
    if (headVerticalAngle + angleVertical > HEAD_MAX_VERTICAL) {
        headVerticalAngle = HEAD_MAX_VERTICAL;
    }
    else if (headVerticalAngle + angleVertical < HEAD_MIN_VERTICAL) {
        headVerticalAngle = HEAD_MIN_VERTICAL;
    }
    else {
